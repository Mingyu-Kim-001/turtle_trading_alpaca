...
2.  **Configure API Keys and Slack**:
    ...
    **Notes**: 
    - The system uses Alpaca paper trading by default
    - To find your Slack channel ID: Right-click on channel → View channel details → Channel ID at bottom
    - If `PERSONAL_SLACK_CHANNEL_ID` is not set, the system will run but notifications will be disabled
